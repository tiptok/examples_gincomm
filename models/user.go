...
type User struct {
	...
	DeletedAt time.Time    `orm:"column(deleted_at)" description:"删除时间"`
	Mobile    string    `orm:"column(mobile);size(20)" description:"手机"`
...
func GetUserByMobile(mobile string)(m *User,err error){
	o:=orm.NewOrm()
	m = &User{Mobile:mobile}
	if err=o.Read(m,"Mobile");err!=nil{
		return m,err
	}
	return
}
